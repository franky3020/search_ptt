...
ptt_start_index=int(sys.argv[1])
ptt_end_index=int(sys.argv[2])
for page_index in range(ptt_start_index,ptt_end_index):
    ...
    for page in page_list:
        ...
        for msg in msgObject_list:
            ...
            try:
                ...
                print("[ERROR] page_index: ",page_index,", ",page.title,", ",msg.msg)
